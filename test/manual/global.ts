import { IClassDecorator, IFieldDecorator, IMethodDecorator, IParamsDecorator, ISetConfig } from "../../src/types/decorator";

declare global {
    namespace globalThis {
       const classDecorator: IClassDecorator;
       const createDecorator: IClassDecorator;
       const fieldDecorator: IFieldDecorator;
       const methodDecorator: IMethodDecorator;
       const paramsDecorator: IParamsDecorator;
